    ...
    <div className="privacy-policy-overlay" onClick={onClose}>
      <div className="privacy-policy-content" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="privacy-policy-body">
          ...
          <h5>b) Usage Data</h5>
          <p>We may also collect information about how the Service is accessed and used ("Usage Data"). This Usage Data may include information such as game scores, difficulty levels selected, and time spent playing the game.</p>
